...
# Embedding weights
embedding_dim = 50
embedding_matrix = np.zeros((len(tk.word_index)+1, embedding_dim)) # fist row represent padding with 0, 71x50
for char, i in tk.word_index.items():  # tk.word_index contain 69 char
